# Instruction: Setting Up GitHub Pages with GitHub Actions
...
Create `.github/workflows/deploy.yml`. Below is the complete working example from the vadocs project, with line-by-line explanation.
