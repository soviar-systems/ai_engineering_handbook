# Transferring Personal GitHub Repos to an Organization
...
3. Type the organization name (e.g. `soviar-systems`) and confirm
4. Repeat for each repo

## Option B: GitHub API via `gh`
...
```bash
gh api repos/lefthand67/vadocs/transfer \
  --method POST \
  --field new_owner=soviar-systems
```
